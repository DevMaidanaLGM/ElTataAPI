...
namespace ElTataAPI.Controllers
{
    ...
    public class IngredientesController : ControllerBase
    {
        ...
        {
            if (id != ingrediente.Id_Ingrediente)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Ingrediente>> PostIngrediente(Ingrediente ingrediente)
        {
          if (_context.Ingredientes == null)
          {
            ...
            return CreatedAtAction("GetIngrediente", new { id = ingrediente.Id_Ingrediente }, ingrediente);
        }
        ...
        {
            return (_context.Ingredientes?.Any(e => e.Id_Ingrediente == id)).GetValueOrDefault();
        }
    }
}
